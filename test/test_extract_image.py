...
palm_contour4, palm_center4, palm_size4, fingertips4 = extract_image(im4)
...
for fingertip in fingertips4:
    cv2.circle(im4, fingertip, 5, (0, 0, 255), 5)
